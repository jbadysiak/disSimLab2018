...
import static dissimlab.simcore.SimParameters.SimDateField.*;
...
*/
	...
	public int simHour(){
		return simObject.simDate(HOUR24);
	}

	public int simMinute(){
		return simObject.simDate(MINUTE);
	}

	public int simSecond(){
		return simObject.simDate(SECOND);
	}

	public int simMillisecond(){
		return simObject.simDate(MILLISECOND);
	}
